...
This project was developed heavily with the assistance of Claude (Opus 4 and Sonnet 3.5), with approximately 99% of the code generated by Claude Code through careful prompting and iterative development. While this library is currently in use in production instances and has been tested against multiple APIs and HTTP/2 endpoints, it should be considered experimental.
...
- Each component, including the Circuit Breaker and Circuit Breaker Persistence Adapters, is in use in production environments but should be considered somewhat experimental
